...
{
    public class SelectOneFlatResourceMapper : IMapToNew<SelectOneFlat, SelectOneFlatResource>
    {
        public async Task<SelectOneFlatResource> Map(SelectOneFlat @from, CancellationToken cancellationToken)
        {
