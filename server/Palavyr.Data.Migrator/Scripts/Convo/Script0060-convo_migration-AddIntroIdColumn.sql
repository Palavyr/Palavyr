...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210819144335_RenameConvoTablesAndAddIsDeleted') THEN
    DROP TABLE "CompletedConversations";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210819144335_RenameConvoTablesAndAddIsDeleted') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210819144335_RenameConvoTablesAndAddIsDeleted', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210819151248_addFallbackColumn') THEN
    ALTER TABLE "ConversationRecords" ADD "IsFallback" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210819151248_addFallbackColumn') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210819151248_addFallbackColumn', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210820044107_AddIsCompleteColumn') THEN
    ALTER TABLE "ConversationRecords" ADD "IsComplete" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210820044107_AddIsCompleteColumn') THEN
    ALTER TABLE "ConversationRecords" ADD "Locale" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210820044107_AddIsCompleteColumn') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210820044107_AddIsCompleteColumn', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210822101808_AddIntroIdColumn') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210822101808_AddIntroIdColumn', '3.1.13');
    END IF;
END $$;
