...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20220310052443_UseFileAssetsUseStripeWebhookReceivedRecord') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20220310052443_UseFileAssetsUseStripeWebhookReceivedRecord', '3.1.13');
    END IF;
END $$;
