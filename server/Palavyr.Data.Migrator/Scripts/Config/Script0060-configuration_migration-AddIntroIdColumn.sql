...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210418101601_AddCategoryNestedThreshold') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210418101601_AddCategoryNestedThreshold') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210418101601_AddCategoryNestedThreshold', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210420133153_AddMinMaxThresholdForFallback') THEN
    ALTER TABLE "PercentOfThresholds" ADD "MaxThreshold" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210420133153_AddMinMaxThresholdForFallback') THEN
    ALTER TABLE "PercentOfThresholds" ADD "MinThreshold" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210420133153_AddMinMaxThresholdForFallback') THEN
    ALTER TABLE "CategoryNestedThresholds" ADD "MaxThreshold" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210420133153_AddMinMaxThresholdForFallback') THEN
    ALTER TABLE "CategoryNestedThresholds" ADD "MinThreshold" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210420133153_AddMinMaxThresholdForFallback') THEN
    ALTER TABLE "BasicThresholds" ADD "MaxThreshold" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210420133153_AddMinMaxThresholdForFallback') THEN
    ALTER TABLE "BasicThresholds" ADD "MinThreshold" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210420133153_AddMinMaxThresholdForFallback') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210420133153_AddMinMaxThresholdForFallback', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "PercentOfThresholds" DROP COLUMN "MaxThreshold";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "PercentOfThresholds" DROP COLUMN "MinThreshold";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "CategoryNestedThresholds" DROP COLUMN "MaxThreshold";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "CategoryNestedThresholds" DROP COLUMN "MinThreshold";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "BasicThresholds" DROP COLUMN "MaxThreshold";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "BasicThresholds" DROP COLUMN "MinThreshold";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "PercentOfThresholds" ADD "TriggerFallback" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "CategoryNestedThresholds" ADD "TriggerFallback" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    ALTER TABLE "BasicThresholds" ADD "TriggerFallback" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210421105524_RemoveLowTriggerAndRenameHighThresholdTriggerProp', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210428015229_UseChatHeaderAndLandingHeader') THEN
    ALTER TABLE "WidgetPreferences" DROP COLUMN "Header";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210428015229_UseChatHeaderAndLandingHeader') THEN
    ALTER TABLE "WidgetPreferences" DROP COLUMN "Subtitle";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210428015229_UseChatHeaderAndLandingHeader') THEN
    ALTER TABLE "WidgetPreferences" DROP COLUMN "Title";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210428015229_UseChatHeaderAndLandingHeader') THEN
    ALTER TABLE "WidgetPreferences" ADD "ChatHeader" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210428015229_UseChatHeaderAndLandingHeader') THEN
    ALTER TABLE "WidgetPreferences" ADD "LandingHeader" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210428015229_UseChatHeaderAndLandingHeader') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210428015229_UseChatHeaderAndLandingHeader', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210501152107_AddS3KeyToFileNameMap') THEN
    ALTER TABLE "FileNameMaps" ADD "S3Key" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210501152107_AddS3KeyToFileNameMap') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210501152107_AddS3KeyToFileNameMap', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210502104656_AddOptionToSendEmailOnFallback') THEN
    ALTER TABLE "Areas" ADD "SendAttachmentsOnFallback" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210502104656_AddOptionToSendEmailOnFallback') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210502104656_AddOptionToSendEmailOnFallback', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210504073242_AddButtonWidgetPrefs') THEN
    ALTER TABLE "WidgetPreferences" ADD "ButtonColor" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210504073242_AddButtonWidgetPrefs') THEN
    ALTER TABLE "WidgetPreferences" ADD "ButtonFontColor" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210504073242_AddButtonWidgetPrefs') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210504073242_AddButtonWidgetPrefs', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210521121703_AddIsImageNodePropertyToConvoNode') THEN
    ALTER TABLE "ConversationNodes" ADD "IsImageNode" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210521121703_AddIsImageNodePropertyToConvoNode') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210521121703_AddIsImageNodePropertyToConvoNode', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210521134243_addimageKeyToConvoNode') THEN
    ALTER TABLE "ConversationNodes" ADD "ImageS3Key" text NOT NULL DEFAULT '';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210521134243_addimageKeyToConvoNode') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210521134243_addimageKeyToConvoNode', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210522005521_addImagesTableAndUpdateConvoNodeProps') THEN
    ALTER TABLE "ConversationNodes" DROP COLUMN "ImageS3Key";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210522005521_addImagesTableAndUpdateConvoNodeProps') THEN
    ALTER TABLE "ConversationNodes" ADD "ImageId" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210522005521_addImagesTableAndUpdateConvoNodeProps') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210522005521_addImagesTableAndUpdateConvoNodeProps', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210522072539_addIsUrlToImages') THEN
    ALTER TABLE "Images" ADD "IsUrl" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210522072539_addIsUrlToImages') THEN
    ALTER TABLE "Images" ADD "Url" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210522072539_addIsUrlToImages') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210522072539_addIsUrlToImages', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210523085447_updateNullabilityInImage') THEN
    ALTER TABLE "Images" ALTER COLUMN "ImageId" TYPE text;
    ALTER TABLE "Images" ALTER COLUMN "ImageId" SET NOT NULL;
    ALTER TABLE "Images" ALTER COLUMN "ImageId" DROP DEFAULT;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210523085447_updateNullabilityInImage') THEN
    ALTER TABLE "Images" ALTER COLUMN "AccountId" TYPE text;
    ALTER TABLE "Images" ALTER COLUMN "AccountId" SET NOT NULL;
    ALTER TABLE "Images" ALTER COLUMN "AccountId" DROP DEFAULT;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210523085447_updateNullabilityInImage') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210523085447_updateNullabilityInImage', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210523225726_addSendPdfResponseOption') THEN
    ALTER TABLE "Areas" ADD "SendPdfResponse" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210523225726_addSendPdfResponseOption') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210523225726_addSendPdfResponseOption', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210529025004_AddShowSeenEnquiries') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210529025004_AddShowSeenEnquiries', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210613131412_AddIsSplitMergeMergePoint') THEN
    ALTER TABLE "ConversationNodes" ADD "IsSplitMergeMergePoint" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210613131412_AddIsSplitMergeMergePoint') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210613131412_AddIsSplitMergeMergePoint', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210620131532_AddNodeTypeCodeToConversationNode') THEN
    ALTER TABLE "ConversationNodes" ADD "NodeTypeCode" integer NOT NULL DEFAULT 0;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210620131532_AddNodeTypeCodeToConversationNode') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210620131532_AddNodeTypeCodeToConversationNode', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210701122641_RemoveDeprecatedFieldsFromConversationNode') THEN
    ALTER TABLE "ConversationNodes" DROP COLUMN "Fallback";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210701122641_RemoveDeprecatedFieldsFromConversationNode') THEN
    ALTER TABLE "ConversationNodes" DROP COLUMN "IsSplitMergeMergePoint";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210701122641_RemoveDeprecatedFieldsFromConversationNode') THEN
    ALTER TABLE "ConversationNodes" DROP COLUMN "IsSplitMergeType";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210701122641_RemoveDeprecatedFieldsFromConversationNode') THEN
    ALTER TABLE "ConversationNodes" ADD "IsLoopbackAnchorType" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210701122641_RemoveDeprecatedFieldsFromConversationNode') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210701122641_RemoveDeprecatedFieldsFromConversationNode', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210716134513_RenameMultiItemProperties') THEN
    ALTER TABLE "TwoNestedCategories" DROP COLUMN "Category";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210716134513_RenameMultiItemProperties') THEN
    ALTER TABLE "TwoNestedCategories" DROP COLUMN "SubCategory";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210716134513_RenameMultiItemProperties') THEN
    ALTER TABLE "CategoryNestedThresholds" DROP COLUMN "Category";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210716134513_RenameMultiItemProperties') THEN
    ALTER TABLE "TwoNestedCategories" ADD "InnerItemName" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210716134513_RenameMultiItemProperties') THEN
    ALTER TABLE "TwoNestedCategories" ADD "ItemName" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210716134513_RenameMultiItemProperties') THEN
    ALTER TABLE "PercentOfThresholds" ADD "ItemOrder" integer NOT NULL DEFAULT 0;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210716134513_RenameMultiItemProperties') THEN
    ALTER TABLE "CategoryNestedThresholds" ADD "ItemName" text NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210716134513_RenameMultiItemProperties') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210716134513_RenameMultiItemProperties', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210819144321_RenameConvoTablesAndAddIsDeleted') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210819144321_RenameConvoTablesAndAddIsDeleted', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210819151234_addFallbackColumn') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210819151234_addFallbackColumn', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210820044059_AddIsCompleteColumn') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210820044059_AddIsCompleteColumn', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210822101801_AddIntroIdColumn') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20210822101801_AddIntroIdColumn', '3.1.13');
    END IF;
END $$;
