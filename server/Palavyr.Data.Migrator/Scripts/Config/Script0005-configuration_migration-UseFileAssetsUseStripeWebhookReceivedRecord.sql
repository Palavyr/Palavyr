...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20220302085322_AddFileAssetDbSet') THEN
    CREATE TABLE "FileAssets" (
        "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
        "AccountId" text NULL,
        "FileId" text NULL,
        "SafeNameStem" text NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20220302085322_AddFileAssetDbSet') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20220302085322_AddFileAssetDbSet', '3.1.13');
    END IF;
END $$;

DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20220310052436_UseFileAssetsUseStripeWebhookReceivedRecord') THEN
    DROP TABLE "FileNameMaps";
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20220310052436_UseFileAssetsUseStripeWebhookReceivedRecord') THEN
    ALTER TABLE "FileAssets" DROP COLUMN "SafeNameStem";
    END IF;
END $$;
...
BEGIN
    ...
    CREATE TABLE "AttachmentRecords" (
        ...
        CONSTRAINT "FK_AttachmentRecords_Areas_AreaId" FOREIGN KEY ("AreaId") REFERENCES "Areas" ("Id") ON DELETE RESTRICT
    );
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20220310052436_UseFileAssetsUseStripeWebhookReceivedRecord') THEN
    CREATE INDEX "IX_AttachmentRecords_AreaId" ON "AttachmentRecords" ("AreaId");
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20220310052436_UseFileAssetsUseStripeWebhookReceivedRecord') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20220310052436_UseFileAssetsUseStripeWebhookReceivedRecord', '3.1.13');
    END IF;
END $$;
