...
namespace Palavyr.API.Controllers
{
    ...
    {
        public static List<ConversationNode> CreateDefault(string accountId, string areaIdentifier, string dynamicTableId)
        {
            ...
            var node7Id = Guid.NewGuid().ToString(); // Ending Sequence
