...
{
    [Route(BaseRoute + nameof(TwoNestedCategory))]
    [ApiController]
    public class TwoNestedCategoriesController : PricingStrategyControllerBase<TwoNestedCategory, TwoNestedCategoryResource, ITwoNestedCategoryCompiler>
    {
