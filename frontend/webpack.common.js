...
const { NewFileLoaderRule, TypeScriptLoaderRule, FileLoaderRule, SVGRule, BabelLoaderRule, StylesLoader, URLLoaderRule, CSSMinify, LiteLoadSVGs, SVGRLoader } = require("./webpack/rules");
