...
export class ApiRoutes {
    public Routes = {
        ...
        SetShowDynamicTotals: () => `intent/dynamic-totals`,
        ...
        SaveDynamicTable: (intentId: string, tableType: string, tableId: string) => `tables/dynamic/${tableType}/intent/${intentId}/table/${tableId}`,
