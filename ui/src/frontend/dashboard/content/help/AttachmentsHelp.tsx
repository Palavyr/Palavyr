        ...
        <>
            ...
            <HelpDetails>
                ...
                <span>
                    ...
                    PDF attachments might typically be used to provide standard literature you send to your potential customers. For example, you might include standard forms, company background information, or legal information regarding the intentof
                    inquiry.
                </span>
            </HelpDetails>
        </>
