import { ContextProperties, MessagesState } from "../types";
...
const messagesReducer = {
    ...
    [ADD_NEW_RESPONSE_MESSAGE]: (state: MessagesState, { text, id }) => ({ ...state, messages: [...state.messages, createNewMessage(text, MESSAGE_SENDER.RESPONSE, id)], badgeCount: state.badgeCount + 1 }),
